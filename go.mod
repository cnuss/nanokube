...
require (
	...
	github.com/cnuss/libtunnel v0.0.10
	...
	github.com/k3s-io/kine v0.16.2
...
require (
	...
	github.com/breml/rootcerts v0.3.5 // indirect
...
replace (
	...
	k8s.io/cluster-bootstrap => github.com/kubernetes/cluster-bootstrap v0.36.0
	k8s.io/cri-client => github.com/kubernetes/cri-client v0.36.0
	k8s.io/cri-streaming => ./kubernetes/staging/src/k8s.io/cri-streaming
	k8s.io/csi-translation-lib => github.com/kubernetes/csi-translation-lib v0.36.0
	k8s.io/endpointslice => github.com/kubernetes/endpointslice v0.36.0
	k8s.io/externaljwt => github.com/kubernetes/externaljwt v0.36.0
	k8s.io/kube-aggregator => github.com/kubernetes/kube-aggregator v0.36.0
	k8s.io/kube-controller-manager => github.com/kubernetes/kube-controller-manager v0.36.0
	k8s.io/kube-proxy => github.com/kubernetes/kube-proxy v0.36.0
	k8s.io/kube-scheduler => github.com/kubernetes/kube-scheduler v0.36.0
	k8s.io/kubectl => github.com/kubernetes/kubectl v0.36.0
	k8s.io/kubelet => ./kubernetes/staging/src/k8s.io/kubelet
	k8s.io/kubernetes => ./kubernetes
	k8s.io/pod-security-admission => github.com/kubernetes/pod-security-admission v0.36.0
)
